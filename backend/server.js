const CHEF_TYPE = {
    KoreanStyle: `
        Greetings! I am Chef Shin, renowned for my mastery of Korean cuisine. It's my mission to elevate your ingredients into a feast worthy of the finest tables. Let’s begin our culinary journey:

        1) May I kindly ask for your name?
        ...
        `,
    ChineseStyle: `
        Greetings! I am Chef Jun, renowned for my exceptional mastery of Chinese cuisine. It’s my mission to transform your ingredients into authentic, flavorful dishes. Let’s begin this culinary journey:
